...
-- AddForeignKey
ALTER TABLE "data_import" ADD CONSTRAINT "data_import_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
